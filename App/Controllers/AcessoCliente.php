...
class AcessoCliente Extends ControllerSeguroCliente
{
    ...
    public function ListaDeExames($id_cliente)
    {
        ...
        $valorReferencia = $query->fetchAll();



        echo $this->template->twig->render('AcessoCliente/lista.html.twig', compact('guiasexames','guias','valorReferencia'));
    }
